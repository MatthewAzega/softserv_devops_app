...
#curl wttr.in/NewYork.png?mM --output /var/www/html/NewYork.png
#echo "<img src="NewYork.png" alt="NewYork">" >> /var/www/html/index.html
#curl wttr.in/Tokyo.png?mM --output /var/www/html/Tokyo.png
#echo "<img src="Tokyo.png" alt="Tokyo">" >> /var/www/html/index.html
